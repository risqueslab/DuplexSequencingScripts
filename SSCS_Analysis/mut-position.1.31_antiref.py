...
def MutPos(o, f, fOut):
    ...
    #convert sequence information to reverse complementary base
          linebins[4] = linebins[4].replace('t','A')
          linebins[4] = linebins[4].replace('c','G')
          linebins[4] = linebins[4].replace('g','C')
          linebins[4] = linebins[4].replace('a','T')
    ...
    #count position-specific mutation frequency
                ...
                #Convert reference base to anti-reference base
                ref = linebins[2]
                antiref = ''
                if ref == 'A':
                	antiref = 'T'
                ...
                template.append(antiref)
                		                                  
   
   	# NOTE: Output file will now be in the reverse complementary orientation.
